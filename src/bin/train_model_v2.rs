// File: src/bin/train_model_v2.rs
//
// M1: train the v2 pair-bigram grammar (context-dependent transitions over
// aligned akshara/chunk pairs) and save it as data/pair_model_v2.bin.
//
...
fn main() {
    ...
    let mut out = PathBuf::from("data/pair_model_v2.bin");
