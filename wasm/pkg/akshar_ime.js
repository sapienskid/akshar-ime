 ...
 */
export function createEngineFromModelUrl(model_url) {
    const ptr0 = passStringToWasm0(model_url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.createEngineFromModelUrl(ptr0, len0);
    return ret;
}
 ...
 * ```
 * @param {string} model_url
 * @param {string | null} [lexicon_url]
 * @param {string | null} [reranker_url]
 * @returns {Promise<WasmEngine>}
 */
export function createEngine(model_url, lexicon_url, reranker_url) {
    const ptr0 = passStringToWasm0(model_url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    var ptr1 = isLikeNone(lexicon_url) ? 0 : passStringToWasm0(lexicon_url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len1 = WASM_VECTOR_LEN;
    var ptr2 = isLikeNone(reranker_url) ? 0 : passStringToWasm0(reranker_url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len2 = WASM_VECTOR_LEN;
    const ret = wasm.createEngine(ptr0, len0, ptr1, len1, ptr2, len2);
    return ret;
}
...
export class WasmEngine {
     ...
     * @param {string | null} [reranker_json]
     */
    constructor(model_bytes, lexicon_bytes, reranker_json) {
        const ptr0 = passArray8ToWasm0(model_bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        var ptr1 = isLikeNone(lexicon_bytes) ? 0 : passArray8ToWasm0(lexicon_bytes, wasm.__wbindgen_malloc);
        var len1 = WASM_VECTOR_LEN;
        var ptr2 = isLikeNone(reranker_json) ? 0 : passStringToWasm0(reranker_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len2 = WASM_VECTOR_LEN;
        const ret = wasm.wasmengine_from_bytes(ptr0, len0, ptr1, len1, ptr2, len2);
        if (ret[2]) {
     ...
     */
    vocabSize() {
        const ret = wasm.wasmengine_vocabSize(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    exportState() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.wasmengine_exportState(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
    ...
    importState(b64) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmengine_importState(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
     ...
     */
    learnedCount() {
        const ret = wasm.wasmengine_learnedCount(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    transliterate(roman) {
        ...
        try {
            const ptr0 = passStringToWasm0(roman, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmengine_transliterate(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    resetLearning() {
        const ret = wasm.wasmengine_resetLearning(this.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @returns {any[]}
     */
    getSuggestions(prefix, count) {
        const ptr0 = passStringToWasm0(prefix, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmengine_getSuggestions(this.__wbg_ptr, ptr0, len0, isLikeNone(count) ? 0x100000001 : (count) >>> 0);
     ...
     * @returns {string}
     */
    getSuggestionsWithScores(prefix, count) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ptr0 = passStringToWasm0(prefix, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmengine_getSuggestionsWithScores(this.__wbg_ptr, ptr0, len0, isLikeNone(count) ? 0x100000001 : (count) >>> 0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    static empty() {
        const ret = wasm.wasmengine_empty();
     ...
     */
    confirm(roman, devanagari) {
        const ptr0 = passStringToWasm0(roman, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(devanagari, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        wasm.wasmengine_confirm(this.__wbg_ptr, ptr0, len0, ptr1, len1);
    }
    /**
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_wasmengine_new = function(arg0) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('akshar_ime_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
